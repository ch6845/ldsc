...
def _read_M(args, log, n_annot):
    ...
    #print _splitp(args.ref_ld_chr), _N_CHR, args.not_M_5_50
    #print M_annot
    #print 1
    try:
...
def estimate_h2(args, log):
    ...
    #print M_annot, w_ld_cname, ref_ld_cnames, sumstats, novar_cols
...
if __name__=='__main__':
    ...
    myfunc(args, 3640)
    #('cannot reshape array of size 3638 into shape (1,3640)',)